...
## `lpfnWndProc`
윈도우즈에서는 윈도우 클래스에 [창 프로시제](https://learn.microsoft.com/ko-kr/windows/win32/winmsg/window-procedures)라는 콜백 함수를 등록하여 윈도우 클래스에 전달되는 모든 "메세지"(마우스 움직임, 타이머 등)를 해당 함수로 전달한다. 
